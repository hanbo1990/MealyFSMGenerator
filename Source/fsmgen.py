...
def main(argv):
    ...
    if t_type == "drawio":
        from SMInfoParser.DrawioPngParser import DrawioPngParser
        sm_info_extractor = DrawioPngParser()
    elif t_type == "dot":
    ...
    sm_transitions = sm_info_extractor.get_sm_jump_info_list_from_file(input_path)
